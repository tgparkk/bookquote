...
- 2026-05-17 [캘린더] 세그먼트 합류 결정(PR17, DECISIONS 2026-05-17 "독서 시작·완독일 캘린더..."). 풀스펙 = `library-calendar.md`. [인용구] 세그먼트(원래 V1.5 보강 권고 #④)는 PR17과 묶음으로 V1.0에 끌어올림 — 서재 화면 두 번 건드림 회피.
