...
- [~] **PR12** 언두 ≥20 · 폰트 ± · 5스와치 적용/다른 느낌 ↻ · auto-fit 경고 · 접근성 · ~~골든 스냅샷 15장(5×3) + 회귀~~ — 골든 12장(4종×3비율, T4 제외) + 폰트 로드 보장 **완료** (2026-05-16). 나머지 본작업(언두·폰트±·5스와치·auto-fit·접근성)은 미착수
